...
////Details Datatable
	//Supplier
  if ($("#suppliers-data-table")[0]) {
    $("#suppliers-data-table").DataTable({
      autoWidth: !1,
      responsive: !0,
      lengthMenu: [
        [15, 30, 45, -1],
  ...
  //Invoices
  if ($("#invoices-data-table")[0]) {
    $("#invoices-data-table").DataTable({
      autoWidth: !1,
      responsive: !0,
      lengthMenu: [
        [15, 30, 45, -1],
  ...
  //Deliveries
  if ($("#deliveries-data-table")[0]) {
    $("#deliveries-data-table").DataTable({
      autoWidth: !1,
      responsive: !0,
      lengthMenu: [
        [15, 30, 45, -1],
  ...
  //Quotations
  if ($("#quotes-data-table")[0]) {
    $("#quotes-data-table").DataTable({
      autoWidth: !1,
      responsive: !0,
      lengthMenu: [
        [15, 30, 45, -1],
